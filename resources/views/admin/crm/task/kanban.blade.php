                                        ...
                                        <div class="avatar-group float-start task-assigne">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-4">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-5">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                        ...
                                        <div class="avatar-group float-start task-assigne">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-1">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                        ...
                                        <ul class="list-inine ps-0 mb-4">
                                                ...
                                                <a href="javascript: void(0);">
                                                    <div class="border rounded avatar-sm">
                                                        <span class="avatar-title bg-transparent">
                                                            <img src="{{URL::asset('admin/assets/images/companies/img-1.png')}}" alt="" class="avatar-xs">
                                                        </span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);">
                                                    <div class="border rounded avatar-sm">
                                                        <span class="avatar-title bg-transparent">
                                                            <img src="{{URL::asset('admin/assets/images/companies/img-2.png')}}" alt="" class="avatar-xs">
                                                        </span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);">
                                                    <div class="border rounded avatar-sm">
                                                        <span class="avatar-title bg-transparent">
                                                            <img src="{{URL::asset('admin/assets/images/companies/img-3.png')}}" alt="" class="avatar-xs">
                                                        </span>
                                                    </div>
                                                </a>
                                            </li>
                                        ...
                                        <div class="avatar-group float-start task-assigne">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-7">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-7.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-8">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card task-box" id="intask-2">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-group float-start task-assigne">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-6.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-4">
                                        ...
                                        <div class="avatar-group float-start task-assigne">
                                            ...
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block" value="member-3">
                                                    <img src="{{URL::asset('admin/assets/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-inline mb-4">
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);">
                                                    <div>
                                                        <img src="{{URL::asset('admin/assets/images/small/img-4.jpg')}}" class="rounded" alt="" height="48">
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);">
                                                    <div>
                                                        <img src="{{URL::asset('admin/assets/images/small/img-5.jpg')}}" class="rounded" alt="" height="48">
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);">
                                                    <div>
                                                        <img src="{{URL::asset('admin/assets/images/small/img-6.jpg')}}" class="rounded" alt="" height="48">
                                                    </div>
                                                </a>
                                            </li>
                                        </ul>
...
@include('admin.crm.task.modal')

@endsection
@section('js')
<!-- dragula plugins -->
<script src="{{URL::asset('admin/assets/libs/dragula/dragula.min.js')}}"></script>
<script src="{{URL::asset('admin/assets/js/pages/task-kanban.init.js')}}"></script>
<script src="{{URL::asset('admin/assets/js/pages/task-form.init.js')}}"></script>
@endsection