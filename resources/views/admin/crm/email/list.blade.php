                    ...
                    <div class="mt-2">
                        <a href="javascript: void(0);" class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{URL::asset('admin/assets/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="36">
                            </div>
                        ...
                        <a href="javascript: void(0);" class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{URL::asset('admin/assets/images/users/avatar-3.jpg')}}" alt="Generic placeholder image" height="36">
                            </div>
                            <div class="flex-grow-1 chat-user-box">
                        ...
                        <a href="javascript: void(0);" class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{URL::asset('admin/assets/images/users/avatar-4.jpg')}}" alt="Generic placeholder image" height="36">
                            </div>
                            <div class="flex-grow-1 chat-user-box">
                        ...
                        <a href="javascript: void(0);" class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{URL::asset('admin/assets/images/users/avatar-6.jpg')}}" alt="Generic placeholder image" height="36">
                            </div>
                            <div class="flex-grow-1 chat-user-box">
...
<!-- End Page-content -->
    @include('admin.crm.email.modal')
@endsection

@section('js')
  <!--tinymce js-->
  <script src="{{URL::asset('admin/assets/libs/tinymce/tinymce.min.js')}}"></script>
  <script src="{{URL::asset('admin/assets/js/pages/email-editor.init.js')}}"></script>
<!-- email editor init -->
