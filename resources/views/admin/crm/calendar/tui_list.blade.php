...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/assets/libs/tui-calendar/tui-calendar.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/assets/libs/tui-time-picker/tui-time-picker.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/assets/libs/tui-date-picker/tui-date-picker.min.css')}}">
@endsection
@section('content')
...
@section('js')
    <script src="{{URL::asset('admin/assets/libs/tui-calendar/tui.code-snippet/latest/tui-code-snippet.min.js')}}"></script>
    <script src="{{URL::asset('admin/assets/libs/tui-dom/tui-dom.min.js')}}"></script>

    <script src="{{URL::asset('admin/assets/libs/tui-time-picker/tui-time-picker.min.js')}}"></script>
    <script src="{{URL::asset('admin/assets/libs/tui-date-picker/tui-date-picker.min.js')}}"></script>

    <script src="{{URL::asset('admin/assets/libs/moment/min/moment.min.js')}}"></script>
    <script src="{{URL::asset('admin/assets/libs/chance/chance.min.js')}}"></script>

    <script src="{{URL::asset('admin/assets/libs/tui-calendar/tui-calendar.min.js')}}"></script>

    <script src="{{URL::asset('admin/assets/js/pages/calendars.js')}}"></script>
    <script src="{{URL::asset('admin/assets/js/pages/schedules.js')}}"></script>
    <script src="{{URL::asset('admin/assets/js/pages/calendar.init.js')}}"></script>
@endsection