        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Xuất hàng</h4>
                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle">Thông tin phiếu xuất</th>
                                        <th class="align-middle text-end">Sản phẩm</th>
                                        <th class="align-middle text-end">Cần trả NCC</th>
                                        <th class="align-middle text-end">Người xuất</th>
                                        <th class="align-middle text-end">Ngày xuất</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge-soft-success font-size-12">Đã Xuất hàng</span>
                                            <span class="badge badge-pill badge-soft-warning font-size-12">Phiếu tạm </span>
                                            <h5 class="text-body fw-bold font-size-14 my-1">Xuất quần áo nam</h5>
                                            <p class="text-muted mb-0">Mã phiếu: #SK2540</p>
                                            <p class="text-muted mb-1">Chi nhánh: Hà Nội</p>
