                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#customer-all" role="tab" aria-selected="true">
                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                    <span class="d-none d-sm-block">Tất cả</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#customer-loyal" role="tab" aria-selected="false">
                                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                    <span class="d-none d-sm-block">Khách hàng thân thiết</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#customer-potential" role="tab" aria-selected="false">
                                    <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                    <span class="d-none d-sm-block">Khách hàng tiềm năng</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#customer-new" role="tab" aria-selected="false">
                                    <span class="d-block d-sm-none"><i class="fas fa-cog"></i></span>
                                    <span class="d-none d-sm-block">Khách hàng mới</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content mt-3 text-muted">
                            <div class="tab-pane active" id="customer-all" role="tabpanel">
                                @include('admin.ecommerce.contact._table_tab', ['status' => 'Đang hoạt động', 'rank' => 'Khách hàng tiềm năng'])
                            </div>
                            <div class="tab-pane" id="customer-loyal" role="tabpanel">
                                @include('admin.ecommerce.contact._table_tab', ['status' => 'Ngừng hoạt động', 'rank' => 'Khách hàng thân thiết'])
                            </div>
                            <div class="tab-pane" id="customer-potential" role="tabpanel">
                                @include('admin.ecommerce.contact._table_tab', ['status' => 'Đang hoạt động', 'rank' => 'Khách hàng tiềm năng'])
                            </div>
                            <div class="tab-pane" id="customer-new" role="tabpanel">
                                @include('admin.ecommerce.contact._table_tab', ['status' => 'Đang hoạt động', 'rank' => 'Khách hàng mới'])
                            </div>
                        </div>
