                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle">Tên tùy chọn</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex gap-3 float-end">
                                                <a href="{{action('App\Http\Controllers\Admin\Ecommerce\CategoryController@edit',['id' => 1]) }}" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                <a href="{{action('App\Http\Controllers\Admin\Ecommerce\CategoryController@destroy',['id' => 1]) }}" class="text-danger"><i class="mdi mdi-delete font-size-18"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
