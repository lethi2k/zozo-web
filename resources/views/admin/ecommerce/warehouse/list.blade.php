                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Quản lý</label>
                                    <div class="col-md-10">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <div class="input-group">
                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle text-end">SL chênh lệch</th>
                                        <th class="align-middle text-end">Giá chênh lệch</th>
                                        <th class="align-middle text-end">Quản lý</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex" style="align-items: center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0">SKU: SPA</p>
                                                    <p class="text-muted mb-1">Mã kho: #SK2540</p>
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-end">
                                            <p class="text-muted text-truncate mb-0">2,500,000.đ (<i class="mdi mdi-arrow-up text-success"></i> 0.2 %)</p>
                                        </td>
                                        <td class="text-end">
                                            100
                                        </td>
