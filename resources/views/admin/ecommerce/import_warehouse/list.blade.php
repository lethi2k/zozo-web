        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Nhập hàng</h4>
                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle">Thông tin phiếu nhập</th>
                                        <th class="align-middle text-end">Sản phẩm</th>
                                        <th class="align-middle text-end">Cần trả NCC</th>
                                        <th class="align-middle text-end">Người nhập</th>
                                        <th class="align-middle text-end">Ngày nhập</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge-soft-success font-size-12">Đã nhập hàng</span>
                                            <span class="badge badge-pill badge-soft-warning font-size-12">Phiếu tạm </span>
                                            <h5 class="text-body fw-bold font-size-14 my-1">Nhập quần áo nam</h5>
