        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Bài đăng của tôi</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Thương mại điện tử</a></li>
                            <li class="breadcrumb-item active">Bài đăng của tôi</li>
                        </ol>
                    </div>
                            ...
                            <div class="col-xxl-8 col-lg-12 mb-3">
                                <div class="d-md-flex flex-md-row-reverse flex-sm-column bd-highlight">
                                    ...
                                    <div class="p-xxl-3 p-md-2 bd-highlight row">
                                        <label for="example-text-input" class="col-md-3 col-form-label">Ngày đăng bài</label>
                                        <div class="col-md-9">
                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle">Tên Bài đăng của tôi</th>
