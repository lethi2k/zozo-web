                            ...
                            <table class="table align-middle table-nowrap table-check">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="align-middle">tin tức</th>
                                        <th>Trạng thái</th>
                                        <th>Người tạo</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex" style="align-items: center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="text-body fw-bold font-size-14 my-1">Quần áo nam</h5>
                                                    <p class="text-muted mb-1">STT: 1</p>
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <br>
                                            <a href="javascript: void(0);" class="mb-2">Xóa</a>
                                        </td>
                                    </tr>
